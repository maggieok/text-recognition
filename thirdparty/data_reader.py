            ...
            while True:
                for i in range(sizes):
                    ...
                    for j in range(batchsize):
                        ...
                        label = [int(c) + 2 for c in items[-1].split(',')]
                        img = Image.open(os.path.join(img_root_dir, items[
                           2])).convert('L')  #zhuanhuidu
                        # img = Image.open(items[2]).convert('L')
                        if j == 0:
                            sz = img.size
...
def train(batch_size,
    ...
    shuffle = True
    #train_list_file ="/home/users/xuhailun/antinoise/eng/train_data/train_data/167w_eng_online/train_list_20conv/with_chn_more/random_train_local_20180814_check_withoutlong.txt"
    # train_list_file = "/home/vis/data/eng_syn_norm/train_img_eng_syn_norm_40w.list"
...
def test(batch_size=1,
    ...
    #test_list_file = "/home/users/xuhailun/antinoise/eng/train/8conv_att/my_train_local/train_list/dev_check_20181016_new.list"
    # test_list_file = "/home/vis/data/eng_syn_norm/test_img_eng_syn_norm_2k.list"
    return paddle.batch(
